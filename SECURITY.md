...
**NEAT-AI-Ockham** and what to expect once you do. It follows
...
2. **Email.** If you cannot use GitHub private reporting, email
   **security@stsoftware.com.au** with the details. Use the subject line
   `NEAT-AI-Ockham security report`.
...
- the affected component, file, or command (for example the `neat_ai_ockham`
  CLI);
