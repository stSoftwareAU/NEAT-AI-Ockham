...
| `--max-full` | none | Cap winners scored **individually** (highest sample Δ first). Never restricts bundle membership — every screened winner is still offered to combination bundles. |
