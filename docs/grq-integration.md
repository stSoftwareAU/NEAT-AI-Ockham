...
learnings/visits/<host>.jsonl                           eligible-visit ledger, general population
...
learnings-team-<island>/visits/<host>.jsonl             eligible-visit ledger, one island
```
